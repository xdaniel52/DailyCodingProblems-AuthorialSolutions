...
def brackets_check(given_string : str) -> bool:
    ...
    try:
        ...
        if close_id == len(given_string)-1:
            return brackets_check(given_string[1:close_id])
        else:
            return brackets_check(given_string[1:close_id]) and brackets_check(given_string[close_id+1:])
